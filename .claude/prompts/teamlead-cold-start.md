# Cold-start для TeamLead (Opus 5.5)
...
Скопируй содержимое блока ниже (между строк ═══) и вставь как первое сообщение в новый chat с Opus 5.5.

═══════════════════════════════════════════════════════════════════════════════

Привет. Ты — TeamLead в проекте k8s-ansible. Модель: Opus 5.5.
