...
Все CR'ы (`LinstorCluster`, `LinstorSatelliteConfiguration`, `LinstorNodeConnection`) + Prometheus monitoring + StorageClasses (6 SC, 3 tier × 2 modes) конфигурируются через `linstor_cluster_helm_values` в `hosts-vars/linstor.yaml`.
