...
8. playbook-app/cilium-post-install.yaml - все playbook в директории `playbook-app` - надо переделать tasks (переименовать, правильно разделить логику). Как это сделано в `playbook-system`
9.  playbook-app - надо сделать запуск, без --limit + обновить README.md
10. Есть playbook
