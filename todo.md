...
4. Добавить контроль по: убирать taint с control-plane или нет
...
5. Обновить task = tasks-gather-cluster-facts.yaml
...
7.  Добавить установку https://github.com/stakater/Reloader
    1.  перезапуск подов, если configMap | secret - изменились
8.  Добавить установку https://zitadel.com/docs
    1.  система авторизации и управления доступами
9.  ArgoCD - отделить установку ingress, в отдельный helm-chart (стадия - post)
10. Есть playbook
