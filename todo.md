...
3. metrics-api - перенести в другойnamespace. Сейчас оно в kube-system ... (что очень странно)
   1. Там будет небольшая проблема с networkPolicy
4. ротация
   1. Vault
...
- Написать в инструкции, примеры, как надо хранить в VAULT секреты для всех типов репозиториев
