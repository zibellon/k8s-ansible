...
| `playbook-app/tasks/` | 34 reusable task includes (pre-check, copy-chart, helm, wait, Vault/ESO, k8s-list, cluster-info) + 3 seaweedfs task includes в `playbook-app/tasks/seaweedfs/` subdir (user-sync, bucket-sync, bucket-policy-sync) | [`reusable-tasks.md`](.claude/rules/reusable-tasks.md) §1 |
